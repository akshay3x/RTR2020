...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay, gWindow, "XWindow Graphpaper Shapes");
...
void drawTriangle(void)
{
	GLfloat MultConst = 0.75f;
	glLineWidth(2.0f);

	glBegin(GL_LINES);
	glColor3f(1.0f, 1.0f, 1.0f);
			glVertex3f(0.0f, 1.0f * MultConst, 0.0f);
			glVertex3f((cos(GLfloat(GL_PI * 7.0/6.0))) * MultConst, sin(GLfloat(GL_PI * 7.0/6.0)) * MultConst, 0.0f);

			glVertex3f(0.0f, 1.0f * MultConst, 0.0f);
			glVertex3f((cos(GLfloat(GL_PI * 11.0/6.0))) * MultConst, sin(GLfloat(GL_PI * 11/6.0)) * MultConst, 0.0f);
...
void drawCircle(void)
{
	...
	glBegin(GL_POINTS);
		...
		{
			glVertex3f(	(GLfloat(((sin(GLfloat(GL_PI * 7.0/6.0)))) * float(cos(i)))* MultConst),
						(GLfloat(((sin(GLfloat(GL_PI * 7.0/6.0)))) * float(sin(i)))* MultConst),
						 0.0f);
		}
	glEnd();
}
...
void drawRect(void)
{
	...
	glColor3f(1.0f, 1.0f, 1.0f);
			...
			glVertex3f(-1.0f * MultConst, 1.0f * MultConst, 0.0f);
			glVertex3f(1.0f * MultConst, 1.0f * MultConst, 0.0f);
...
void drawOutCircle(void)
{
	...
	glBegin(GL_POINTS);
		...
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(	(GLfloat(((sin(GLfloat(GL_PI * 7.0/6.0)))) * float(cos(i)))* MultConst * 2),
						(GLfloat(((sin(GLfloat(GL_PI * 7.0/6.0)))) * float(sin(i)))* MultConst * 2),
						 0.0f);
		}
	glEnd();
}
