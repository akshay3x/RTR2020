...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay, gWindow, "XWindow Orhographic Projection");
...
void resize(int width, int hight)
{
	...
	if(width >= hight)
	{
		glOrtho(-100.0f,
				 100.0f,
				-100.0f * ((GLfloat)hight/(GLfloat)width),
				 100.0f * ((GLfloat)hight/(GLfloat)width),
				-100.0f,
				 100.0f);
	}
	...
	{
		glOrtho(-100.0f * ((GLfloat)width/(GLfloat)hight), 
				 100.0f * ((GLfloat)width/(GLfloat)hight),
				-100.0f,
				 100.0f,
				-100.0f,
				 100.0f);
