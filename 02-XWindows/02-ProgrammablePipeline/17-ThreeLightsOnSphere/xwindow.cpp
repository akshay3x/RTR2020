...
GLuint gProjectionMatrixUniformPerVertex;
...
GLuint gMaterialAmbientUniformPerVertex;
GLuint gMaterialDiffuseUniformPerVertex;
GLuint gMaterialSpecularUniformPerVertex;
GLuint gMaterialShininessUniformPerVertex;

GLuint gLKeyPressedUniformPerVertex;

GLuint gModelMatrixUniformPerFragment;
GLuint gViewMatrixUniformPerFragment;
GLuint gProjectionMatrixUniformPerFragment;
...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay, gWindow, " XWindows | Three Lights on Sphere");
...
void initialize(void)
{
	...
	const GLchar* vertexShaderSourceCodePerFragment =
		...
		" void main(void) \n" \
		"	{ \n" \
		"		out_eye_coordinates	= u_view_matrix * u_model_matrix * vPosition; \n" \
	...
	gProjectionMatrixUniformPerVertex 	= glGetUniformLocation(gShaderProgramObjectPerVertex, "u_projection_matrix");
	...
	gMaterialAmbientUniformPerVertex	= glGetUniformLocation(gShaderProgramObjectPerVertex, "u_ka");
	gMaterialDiffuseUniformPerVertex	= glGetUniformLocation(gShaderProgramObjectPerVertex, "u_kd");
	gMaterialSpecularUniformPerVertex 	= glGetUniformLocation(gShaderProgramObjectPerVertex, "u_ks");
	gMaterialShininessUniformPerVertex	= glGetUniformLocation(gShaderProgramObjectPerVertex, "u_material_shininess");
	...
	gProjectionMatrixUniformPerFragment = glGetUniformLocation(gShaderProgramObjectPerFragment, "u_projection_matrix");
...
void display(void)
{
	...
	if (gbUsePerVertexShader == true)
	{
		...
		if (gbLight == true)
		{
			...
			glUniform4fv(gLightAmbientUniformPerVertex,		3, (GLfloat*)&LightRB.lightAmbientColor);
			glUniform4fv(gLightDiffuseUniformPerVertex,		3, (GLfloat*)&LightRB.lightDiffuseColor);
			glUniform4fv(gLightSpecularUniformPerVertex,	3, (GLfloat*)&LightRB.lightSpecularColor);
			glUniform4fv(gLightPositionUniformPerVertex,	3, (GLfloat*)&LightRB.lightPositionColor);

			glUniform4fv(gMaterialAmbientUniformPerVertex,	1, (GLfloat*)&materialAmbient);
			glUniform4fv(gMaterialDiffuseUniformPerVertex,	1, (GLfloat*)&materialDiffuse);
			glUniform4fv(gMaterialSpecularUniformPerVertex,	1, (GLfloat*)&materialSpecular);
			glUniform1f(gMaterialShininessUniformPerVertex,	128.0f);
		}
		else
		{
		...
		glUniformMatrix4fv(gProjectionMatrixUniformPerVertex, 1, GL_FALSE, gPerspectiveProjectionMatrix);
	...
	if (gbUsePerFragmentShader == true)
	{
		...
		if (gbLight == true)
		{
			...
			glUniform4fv(gLightAmbientUniformPerFragment,	4, (GLfloat*)&LightRB.lightAmbientColor[0]);
			glUniform4fv(gLightDiffuseUniformPerFragment,	4, (GLfloat*)&LightRB.lightDiffuseColor[0]);
			glUniform4fv(gLightSpecularUniformPerFragment,	4, (GLfloat*)&LightRB.lightSpecularColor[0]);
			glUniform4fv(gLightPositionUniformPerFragment,	4, (GLfloat*)&LightRB.lightPositionColor[0]);
			...
			glUniform1f(gMaterialShininessUniformPerFragment,	256.0f);
		}
		else
		{
		...
		glUniformMatrix4fv(gProjectionMatrixUniformPerFragment, 1, GL_FALSE, gPerspectiveProjectionMatrix);
