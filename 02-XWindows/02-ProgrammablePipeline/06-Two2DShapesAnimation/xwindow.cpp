...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay, gWindow, " XWindows | 2D Shapes Animation");
...
void display(void)
{
	...
	rotationMatrix = rotate(angleRotate, 0.0f, 1.0f, 0.0f);
	...
	translateMatrix = translate( 2.0f, 0.0f, -6.0f);
	rotationMatrix = rotate(angleRotate, 1.0f, 0.0f, 0.0f);
