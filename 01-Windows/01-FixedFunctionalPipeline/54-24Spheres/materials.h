...
GLfloat materialAmbient01[]  = { 0.0215f,  0.1745f,   0.0215f,  1.0f};
GLfloat materialDiffuse01[]  = { 0.07568f, 0.61424f,  0.07568f, 1.0f};
GLfloat materialSpecular01[] = { 0.633f,   0.727811f, 0.633f,   1.0f};
GLfloat materialShininess01 = 0.6 * 128.0f;

// ***** 2nd sphere on 1st column, jade *****
GLfloat materialAmbient02[]  = { 0.135f,    0.2225f,   0.1575f,   1.0f};
GLfloat materialDiffuse02[]  = { 0.54f,     0.89f,     0.63f,     1.0f};
GLfloat materialSpecular02[] = { 0.316228f, 0.316228f, 0.316228f, 1.0f};
GLfloat materialShininess02 = 0.1f * 128.0f;

// ***** 3rd sphere on 1st column, obsidian *****
GLfloat materialAmbient03[]  = { 0.05375f,  0.05f,     0.06625f,  1.0f};
GLfloat materialDiffuse03[]  = { 0.18275f,  0.17f,     0.22525f,  1.0f};
GLfloat materialSpecular03[] = { 0.332741f, 0.328634f, 0.346435f, 1.0f};
GLfloat materialShininess03 = 0.3f * 128.0f;

// ***** 4th sphere on 1st column, pearl *****
GLfloat materialAmbient04[]  = { 0.25f,     0.20725f,  0.20725f,  1.0f};
GLfloat materialDiffuse04[]  = { 1.0f,      0.829f,    0.829f,    1.0f};
GLfloat materialSpecular04[] = { 0.296648f, 0.296648f, 0.296648f, 1.0f};
GLfloat materialShininess04 = 0.088f * 128.0f;

// ***** 5th sphere on 1st column, ruby *****
GLfloat materialAmbient05[]  = { 0.1745f,   0.01175f,  0.01175f,  1.0f};
GLfloat materialDiffuse05[]  = { 0.61424f,  0.04136f,  0.04136f,  1.0f};
GLfloat materialSpecular05[] = { 0.727811f, 0.626959f, 0.626959f, 1.0f};
GLfloat materialShininess05 = 0.6f * 128.0f;

// ***** 6th sphere on 1st column, turquoise *****
GLfloat materialAmbient06[]  = { 0.1f,      0.18725f,  0.1745f,   1.0f};
GLfloat materialDiffuse06[]  = { 0.396f,    0.74151f,  0.69102f,  1.0f};
GLfloat materialSpecular06[] = { 0.297254f, 0.30829f,  0.306678f, 1.0f};
GLfloat materialShininess06 = 0.1f * 128.0f;

// ***** 1st sphere on 2nd column, brass *****
GLfloat materialAmbient07[]  = { 0.329412f, 0.223529f, 0.027451f, 1.0f};
GLfloat materialDiffuse07[]  = { 0.780392f, 0.568627f, 0.113725f, 1.0f};
GLfloat materialSpecular07[] = { 0.992157f, 0.941176f, 0.807843f, 1.0f};
GLfloat materialShininess07 = 0.21794872f * 128.0f;

// ***** 2nd sphere on 2nd column, bronze *****
GLfloat materialAmbient08[]  = { 0.2125f,   0.1275f,   0.054f,    1.0f};
GLfloat materialDiffuse08[]  = { 0.714f,    0.4284f,   0.18144f,  1.0f};
GLfloat materialSpecular08[] = { 0.393548f, 0.271906f, 0.166721f, 1.0f};
GLfloat materialShininess08 = 0.2f * 128.0f;

// ***** 3rd sphere on 2nd column, chrome *****
GLfloat materialAmbient09[]  = { 0.25f,     0.25f,     0.25f,     1.0f};
GLfloat materialDiffuse09[]  = { 0.4f,      0.4f,      0.4f,      1.0f};
GLfloat materialSpecular09[] = { 0.774597f, 0.774597f, 0.774597f, 1.0f};
GLfloat materialShininess09 = 0.6f * 128.0f;
...
GLfloat materialAmbient24[]  = { 0.05f, 0.05f, 0.0f,  1.0f};
