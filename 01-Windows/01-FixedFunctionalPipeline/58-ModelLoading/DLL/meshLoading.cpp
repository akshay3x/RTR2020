...
extern "C" __declspec(dllexport) void *xrealloc(void *, size_t );

extern "C" __declspec(dllexport) void *xcalloc(int , size_t );

extern "C" __declspec(dllexport) void clean_vec_2d_float(vec_2d_float_t **);

extern "C" __declspec(dllexport) void clean_vec_2d_int(vec_2d_int_t **);

extern "C" __declspec(dllexport) int push_back_vec_2d_float(vec_2d_float_t *, float *);

extern "C" __declspec(dllexport) int push_back_vec_2d_int(vec_2d_int_t *, int *);

extern "C" __declspec(dllexport) vec_2d_float_t *create_vec_2d_float(void);

extern "C" __declspec(dllexport) vec_2d_int_t *create_vec_2d_int(void);
...
extern "C" __declspec(dllexport) int LoadMeshData(char *meshFile)
{
	...
	g_fp_debugfile = fopen("DEBUG_LOG.TXT", "w");
	if(!g_fp_debugfile)
	...
	fprintf(g_fp_debugfile, "DEBUG:Number Of Vertices = %llu\n", gp_vertices->size);
	fprintf(g_fp_debugfile, "DEBUG:Number Of Textures = %llu\n", gp_textures->size);
	fprintf(g_fp_debugfile, "DEBUG:Number Of Normals  = %llu\n", gp_normals->size);
	fprintf(g_fp_debugfile, "DEBUG:Number Of Face Triangles = %llu\n", gp_face_triangles->size);
	fprintf(g_fp_debugfile, "DEBUG:Number Of Face Texture   = %llu\n", gp_face_texture->size);
	fprintf(g_fp_debugfile, "DEBUG:Number Of Face Normals   = %llu\n", gp_face_normals->size);
...
extern "C" __declspec(dllexport) int push_back_vec_2d_int(vec_2d_int_t *p_vec, int *p_arr)
{
	//code
...
extern "C" __declspec(dllexport) int push_back_vec_2d_float(vec_2d_float_t *p_vec, float *p_arr)
{
	//code
...
extern "C" __declspec(dllexport) void clean_vec_2d_int(vec_2d_int_t **pp_vec)
{
	//Variable Declarations
...
extern "C" __declspec(dllexport) void clean_vec_2d_float(vec_2d_float_t **pp_vec)
{
	//variable declarations
...
extern "C" __declspec(dllexport) void *xcalloc(int nr_elements, size_t size_per_element)
{
	//code
...
extern "C" __declspec(dllexport) void *xrealloc(void *p, size_t new_size)
{
	//code
