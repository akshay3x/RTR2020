...
void display(void)
{
	...
	glBegin(GL_POINTS);
		...
		{
			glVertex3f(0.1f * (float(cos(i))), (0.1f * float(sin(i))), 0.0f);
		}

		glColor3f(0.0f, 1.0f, 0.0f);//2
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.2f * (float(cos(i))), (0.2f * float(sin(i))), 0.0f);
		}

		glColor3f(0.0f, 0.0f, 1.0f);//3
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.3f * (float(cos(i))), (0.3f * float(sin(i))), 0.0f);
		}

		glColor3f(0.0f, 1.0f, 1.0f);//4
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.4f * (float(cos(i))), (0.4f * float(sin(i))), 0.0f);
		}

		glColor3f(1.0f, 0.0f, 1.0f);//5
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.5f * (float(cos(i))), (0.5f * float(sin(i))), 0.0f);
		}

		glColor3f(1.0f, 1.0f, 0.0f);//6
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.6f * (float(cos(i))), (0.6f * float(sin(i))), 0.0f);
		}

		glColor3f(0.5f, 0.5f, 0.5f);//7
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.7f * (float(cos(i))), (0.7f * float(sin(i))), 0.0f);
		}

		glColor3f(0.5f, 0.5f, 0.0f);//8
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.8f * (float(cos(i))), (0.8f * float(sin(i))), 0.0f);
		}

		glColor3f(0.5f, 0.0f, 0.5f);//9
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(0.9f * (float(cos(i))), (0.9f * float(sin(i))), 0.0f);
		}

		glColor3f(0.0f, 0.5f, 0.5f);//10
		for(i = 0; i < 6.28; i = i + 0.0001f )
		{
			glVertex3f(1.0f * (float(cos(i))), (1.0f * float(sin(i))), 0.0f);
		}
	glEnd();
